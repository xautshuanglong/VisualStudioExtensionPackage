...
class HelloWorldWindowPane :
	public CComObjectRootEx<CComSingleThreadModel>,
	public VsWindowPaneFromResource<HelloWorldWindowPane, IDD_HelloWorld_DLG>,
	public VsWindowFrameEventSink<HelloWorldWindowPane>,
...
{
	VSL_DECLARE_NOT_COPYABLE(HelloWorldWindowPane)

protected:

	// Protected constructor called by CComObject<HelloWorldWindowPane>::CreateInstance.
	HelloWorldWindowPane() :
...
BEGIN_COM_MAP(HelloWorldWindowPane)
...
BEGIN_MSG_MAP(HelloWorldWindowPane)
...
END_MSG_MAP()
	...
	{
		VsWindowFrameEventSink<HelloWorldWindowPane>::SetSite(GetVsSiteCache());
...
class HelloWorldToolWindow :
	public VSL::ToolWindowBase<HelloWorldToolWindow>
{
public:
	...
	HelloWorldToolWindow(const PackageVsSiteCache& rPackageVsSiteCache):
	...
	IUnknown* GetViewObject()
	{
		...
		CComObject<HelloWorldWindowPane>* pViewObject;
		VSL_CHECKHRESULT(CComObject<HelloWorldWindowPane>::CreateInstance(&pViewObject));
